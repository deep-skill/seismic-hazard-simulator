...
class KuehnEtAl2020SInter(GMPE):
    ...
    MB_REGIONS = {"Aleutian": 8, "AK": 8.6, "Cascadia": 8.0,
                  "CAM_S": 7.5, "CAM_N": 7.4, "JP_Pac": 8.5, "JP_Phi": 7.7,
                  "SA_N": 8.5, "SA_S": 8.6, "TW_W": 7.1, "TW_E": 7.1,
                  "NZ_N":8.3, "NZ_S":8.0, "default": 7.9}

    def __init__(self, region="GLO", m_b=None, saturation_region=None, basin=None, ergodic = True,
                 sigma_mu_epsilon=0.0, **kwargs):
        super().__init__(region=region, saturation_region=saturation_region,
                         basin=basin, ergodic = ergodic, **kwargs)
...
class KuehnEtAl2020SSlab(KuehnEtAl2020SInter):
    ...
    MB_REGIONS = {"Aleutian": 8, "AK": 7.2, "Cascadia": 7.2,
                  "CAM_S": 7.6, "CAM_N": 7.4, "JP_Pac": 7.6, "JP_Phi": 7.6,
                  "SA_N": 7.3, "SA_S": 7.2, "TW_W": 7.7, "TW_E": 7.7,
                  "NZ_N":7.6, "NZ_S":7.6, "default": 7.9}

class KBCG2020SInterBCHydro15(KuehnEtAl2020SInter):
    """
    ...
    PEER 2020/25
    """
    def __init__(self, ergodic = False, factor=0.0, **kwargs):
        super().__init__(**kwargs)
        self.factor = factor
        self.ergodic = ergodic
            
    def compute(self, ctx: np.recarray, imts, mean, sig, tau, phi):
        # Call compute method from the parent class to get mean values
        super().compute(ctx, imts, mean, sig, tau, phi)
        for m, imt in enumerate(imts):

            # Modify sig based on the conditions in the child class
            if not self.ergodic:
                # Set all elements of sig to 0.74
                sig[m] = 0.74

            if self.factor:
                sig[m] += self.factor

class KBCG2020SSlabBCHydro15(KuehnEtAl2020SInter):
    """
    Implements the 2020 Subduction ground motion model of Abrahamson &
    Gulerce (2020) for subduction in-slab earthquakes
...
add_alias('KuehnEtAl2020SInterAleutian', KuehnEtAl2020SInter,
          region="USA-AK", saturation_region="Aleutian")
add_alias('KuehnEtAl2020SInterAlaska', KuehnEtAl2020SInter,
          region="USA-AK", saturation_region="AK")
add_alias('KuehnEtAl2020SInterCAMN', KuehnEtAl2020SInter,
          region="CAM", saturation_region="CAM_N")
add_alias('KuehnEtAl2020SInterCAMS', KuehnEtAl2020SInter,
          region="CAM", saturation_region="CAM_S")
add_alias('KuehnEtAl2020SInterSAN', KuehnEtAl2020SInter,
          region="SA", saturation_region="SA_N")
add_alias('KBCG2020SInterBCHydro15SAN', KBCG2020SInterBCHydro15,
          region="SA", saturation_region="SA_N")
add_alias('KuehnEtAl2020SInterSAS', KuehnEtAl2020SInter,
          region="SA", saturation_region="SA_S")
add_alias('KBCG2020SInterBCHydro15SAS', KBCG2020SInterBCHydro15,
          region="SA", saturation_region="SA_S")
add_alias('KuehnEtAl2020SInterTaiwanE', KuehnEtAl2020SInter,
          region="TW", saturation_region="TW_E")
add_alias('KuehnEtAl2020SInterTaiwanW', KuehnEtAl2020SInter,
          region="TW", saturation_region="TW_W")
add_alias('KuehnEtAl2020SInterCascadia', KuehnEtAl2020SInter,
          region="Cascadia")
add_alias('KuehnEtAl2020SInterCascadiaOut', KuehnEtAl2020SInter,
          region="Cascadia", basin="out")
add_alias('KuehnEtAl2020SInterCascadiaSeattle', KuehnEtAl2020SInter,
          region="Cascadia", basin="Seattle")
add_alias('KuehnEtAl2020SInterJapanPac', KuehnEtAl2020SInter,
          region="JP", saturation_region="JP_Pac")
add_alias('KuehnEtAl2020SInterJapanPhi', KuehnEtAl2020SInter,
          region="JP", saturation_region="JP_Phi")
add_alias('KuehnEtAl2020SSlabAleutian', KuehnEtAl2020SSlab,
          region="USA-AK", saturation_region="Aleutian")
add_alias('KuehnEtAl2020SSlabAlaska', KuehnEtAl2020SSlab,
          region="USA-AK", saturation_region="AK")
add_alias('KuehnEtAl2020SSlabCAMN', KuehnEtAl2020SSlab,
          region="CAM", saturation_region="CAM_N")
add_alias('KuehnEtAl2020SSlabCAMS', KuehnEtAl2020SSlab,
          region="CAM", saturation_region="CAM_S")
add_alias('KuehnEtAl2020SSlabSAN', KuehnEtAl2020SSlab,
          region="SA", saturation_region="SA_N")
add_alias('KBCG2020SSlabBCHydro15SAN', KBCG2020SSlabBCHydro15,
          region="SA", saturation_region="SA_N")
add_alias('KuehnEtAl2020SSlabSAS', KuehnEtAl2020SSlab,
          region="SA", saturation_region="SA_S")
add_alias('KBCG2020SSlabBCHydro15SAS', KBCG2020SSlabBCHydro15,
          region="SA", saturation_region="SA_S")
add_alias('KuehnEtAl2020SSlabTaiwanE', KuehnEtAl2020SSlab,
          region="TW", saturation_region="TW_E")
add_alias('KuehnEtAl2020SSlabTaiwanW', KuehnEtAl2020SSlab,
          region="TW", saturation_region="TW_W")
add_alias('KuehnEtAl2020SSlabCascadia', KuehnEtAl2020SSlab,
          region="Cascadia")
add_alias('KuehnEtAl2020SSlabCascadiaOut', KuehnEtAl2020SSlab,
          region="Cascadia", basin="out")
add_alias('KuehnEtAl2020SSlabCascadiaSeattle', KuehnEtAl2020SSlab,
          region="Cascadia", basin="Seattle")
add_alias('KuehnEtAl2020SSlabJapanPac', KuehnEtAl2020SSlab,
          region="JP", saturation_region="JP_Pac")
add_alias('KuehnEtAl2020SSlabJapanPhi', KuehnEtAl2020SSlab,
          region="JP", saturation_region="JP_Phi")
